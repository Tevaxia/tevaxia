...
const TYPE_LABELS: Record<string, { label: string; href: string }> = {
  estimation: { label: "Estimation", href: "/de/estimation" },
  valorisation: { label: "EVS Valuation", href: "/de/valorisation" },
  capitalisation: { label: "Capitalisation", href: "/de/valorisation" },
  dcf: { label: "DCF", href: "/de/valorisation" },
  "dcf-multi": { label: "Multi-tenant DCF", href: "/de/dcf-multi" },
  frais: { label: "Acquisition costs", href: "/de/frais-acquisition" },
  "plus-values": { label: "Capital gains", href: "/de/plus-values" },
  loyer: { label: "Invested capital / Rent", href: "/de/calculateur-loyer" },
  aides: { label: "Subsidies simulator", href: "/de/simulateur-aides" },
  "achat-location": { label: "Buy vs Rent", href: "/de/achat-vs-location" },
  "bilan-promoteur": { label: "Developer appraisal", href: "/de/bilan-promoteur" },
};
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        {evaluations.length === 0 ? (
          <div className="rounded-xl border-2 border-dashed border-card-border py-16 text-center">
            ...
            <Link href="/de/valorisation" className="mt-4 inline-block rounded-lg bg-navy px-4 py-2 text-sm font-medium text-white hover:bg-navy-light transition-colors">
              Start a valuation
            </Link>
          </div>
        ) : (
