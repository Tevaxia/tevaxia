...
export async function generateMetadata(): Promise<Metadata> {
  const [t, locale] = await Promise.all([
    getTranslations("solutions.banque.meta"),
    getLocale(),
  ]);
  return {
    title: t("title"),
    description: t("description"),
    alternates: localizedAlternates("/solutions/banque", locale),
  };
}

export default async function BanqueSolutionPage() {
  const [t, locale, ttoc] = await Promise.all([
    getTranslations("solutions.banque"),
    getLocale(),
  ...
  return (
    <PersonaLanding
      ...
      pricing={{
        ...
        ctaEmitHref: `${lp}/outils-bancaires`,
      }}
      faq={{
        title: t("faq.title"),
      ...
      finalCta={{
        ...
        ctaSecondaryHref: `${lp}/outils-bancaires`,
      }}
      toc={{
        label: ttoc("label"),
        hero: ttoc("hero"),
