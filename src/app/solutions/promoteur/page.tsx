...
export async function generateMetadata(): Promise<Metadata> {
  const [t, locale] = await Promise.all([
    getTranslations("solutions.promoteur.meta"),
    getLocale(),
  ]);
  return {
    title: t("title"),
    description: t("description"),
    alternates: localizedAlternates("/solutions/promoteur", locale),
  };
}

export default async function PromoteurSolutionPage() {
  const [t, locale] = await Promise.all([
    getTranslations("solutions.promoteur"),
    getLocale(),
  ]);
  ...
  return (
    <PersonaLanding
      ...
      pricing={{
        ...
        ctaEmitHref: `${lp}/bilan-promoteur`,
      }}
      faq={{
        title: t("faq.title"),
      ...
      finalCta={{
        ...
        ctaSecondaryHref: `${lp}/bilan-promoteur`,
      }}
    />
  );
}
