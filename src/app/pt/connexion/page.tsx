        ...
        <div className="mx-auto max-w-md px-4">
          <div className="rounded-xl border border-card-border bg-card p-8 shadow-sm text-center">
            ...
            <div className="mt-6 space-y-3">
              <Link href="/pt/mes-evaluations" className="block rounded-lg bg-navy px-4 py-2.5 text-sm font-medium text-white hover:bg-navy-light transition-colors">
                My valuations
              </Link>
      ...
      <div className="mx-auto max-w-md px-4">
        <div className="rounded-xl border border-card-border bg-card p-8 shadow-sm">
          ...
          <p className="mt-4 text-center text-xs text-muted">
            ...
            <Link href="/pt/mentions-legales" className="text-navy hover:underline">legal notice</Link>
            {" "}and our{" "}
            <Link href="/pt/confidentialite" className="text-navy hover:underline">privacy policy</Link>.
          </p>
        </div>
      </div>
    </div>
