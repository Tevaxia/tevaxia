...
export async function generateMetadata(): Promise<Metadata> {
  const [t, locale] = await Promise.all([
    getTranslations("guide.regle5Pourcent"),
    getLocale(),
  ]);
  return {
    title: t("title"),
    description: t("metaDescription"),
    alternates: localizedAlternates("/guide/regle-5-pourcent-loyer", locale),
  };
}

export default async function GuideRegle5Pourcent() {
    ...
    <div className="bg-background min-h-screen py-8 sm:py-12">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <p className="mt-4 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/regle-5-pourcent-loyer">{t("intro")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/regle-5-pourcent-loyer">{t("section1Content")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/regle-5-pourcent-loyer">{t("section2Content")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/regle-5-pourcent-loyer">{t("section3Content")}</AutoLink>
        </p>
        ...
        <RelatedGuides currentSlug="regle-5-pourcent-loyer" />
