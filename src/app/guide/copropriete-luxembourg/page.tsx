...
export async function generateMetadata(): Promise<Metadata> {
  const [t, locale] = await Promise.all([
    getTranslations("guide.copropriete"),
    getLocale(),
  ]);
  return {
    title: t("title"),
    description: t("metaDescription"),
    alternates: localizedAlternates("/guide/copropriete-luxembourg", locale),
  };
}
    ...
    <div className="bg-background min-h-screen py-8 sm:py-12">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <p className="mt-4 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/copropriete-luxembourg">{t("intro")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/copropriete-luxembourg">{t("section1Content")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/copropriete-luxembourg">{t("section2Content")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/copropriete-luxembourg">{t("section3Content")}</AutoLink>
        </p>
        ...
        <RelatedGuides currentSlug="copropriete-luxembourg" />
