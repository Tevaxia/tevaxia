...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    alternates: localizedAlternates("/guide/bail-habitation-luxembourg", locale),
  };
}
    ...
    <div className="bg-background min-h-screen py-8 sm:py-12">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <p className="mt-4 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/bail-habitation-luxembourg">{t("intro")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/bail-habitation-luxembourg">{t("section1Content")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/bail-habitation-luxembourg">{t("section2Content")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/bail-habitation-luxembourg">{t("section3Content")}</AutoLink>
        </p>
        ...
        <RelatedGuides currentSlug="bail-habitation-luxembourg" />
