...
export async function generateMetadata(): Promise<Metadata> {
  const [t, locale] = await Promise.all([
    getTranslations("guide.bellegenAkt"),
    getLocale(),
  ]);
  return {
    title: t("title"),
    description: t("metaDescription"),
    alternates: localizedAlternates("/guide/bellegen-akt", locale),
  };
}
    ...
    <div className="bg-background min-h-screen py-8 sm:py-12">
      <div className="mx-auto max-w-3xl px-4 sm:px-6">
        ...
        <p className="mt-4 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/bellegen-akt">{t("intro")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/bellegen-akt">{t("section1Content")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/bellegen-akt">{t("section2Content")}</AutoLink>
        </p>
        ...
        <p className="mt-3 text-base text-slate-700 leading-relaxed">
          <AutoLink currentPath="/guide/bellegen-akt">{t("section3Content")}</AutoLink>
        </p>
        ...
        <RelatedGuides currentSlug="bellegen-akt" />
