    ...
    <div className="bg-background min-h-screen py-8 sm:py-12">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 flex flex-wrap gap-2">
          ...
          <Link href={`${lp}/syndic/coproprietes/${coown.id}/budget`}
          ...
          <Link href={`${lp}/syndic/coproprietes/${coown.id}/cles-repartition`}
          ...
          <Link href={`${lp}/syndic/coproprietes/${coown.id}/annexes`}
            className="inline-flex items-center gap-2 rounded-lg bg-fuchsia-600 px-4 py-2 text-sm font-semibold text-white hover:bg-fuchsia-700">
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 0 0-3.375-3.375h-1.5A1.125 1.125 0 0 1 13.5 7.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 0 0-9-9Z" />
            </svg>
            Annexes AG
          </Link>
          <Link href={`${lp}/syndic/coproprietes/${coown.id}/relances`}
