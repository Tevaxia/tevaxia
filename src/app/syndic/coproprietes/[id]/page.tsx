  ...
  return (
    <div className="bg-background min-h-screen py-8 sm:py-12">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Actions rapides — les outils détaillés sont dans la sidebar gauche */}
        <div className="mt-6 rounded-xl border border-blue-200 bg-blue-50 p-3 text-xs text-blue-900 lg:hidden">
          👈 Utilisez les <strong>outils syndic</strong> dans la sidebar (bouton ☰ en bas à droite sur mobile) pour accéder à la comptabilité, budgets, appels de fonds, AG, relances, travaux, etc.
        </div>

        {/* Raccourcis principaux (conservés pour accès rapide) */}
