...
const TYPE_LABELS: Record<string, { label: string; href: string }> = {
  estimation: { label: "Estimation", href: "/lb/estimation" },
  valorisation: { label: "EVS Valuation", href: "/lb/valorisation" },
  capitalisation: { label: "Capitalisation", href: "/lb/valorisation" },
  dcf: { label: "DCF", href: "/lb/valorisation" },
  "dcf-multi": { label: "Multi-tenant DCF", href: "/lb/dcf-multi" },
  frais: { label: "Acquisition costs", href: "/lb/frais-acquisition" },
  "plus-values": { label: "Capital gains", href: "/lb/plus-values" },
  loyer: { label: "Invested capital / Rent", href: "/lb/calculateur-loyer" },
  aides: { label: "Subsidies simulator", href: "/lb/simulateur-aides" },
  "achat-location": { label: "Buy vs Rent", href: "/lb/achat-vs-location" },
  "bilan-promoteur": { label: "Developer appraisal", href: "/lb/bilan-promoteur" },
};
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        {evaluations.length === 0 ? (
          <div className="rounded-xl border-2 border-dashed border-card-border py-16 text-center">
            ...
            <Link href="/lb/valorisation" className="mt-4 inline-block rounded-lg bg-navy px-4 py-2 text-sm font-medium text-white hover:bg-navy-light transition-colors">
              Start a valuation
            </Link>
          </div>
        ) : (
